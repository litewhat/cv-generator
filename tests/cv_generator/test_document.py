...
class TestContentFromMappingNodes:
    ...
    @pytest.mark.parametrize('filename', ['empty-social-profiles.json', 'github-only.json', 'linkedin-only.json', 'mixed-children.json', 'mixed-root.json', 'nested-experience.json', 'production-like.json', 'root-strings.json'])
...
class TestDocumentParse:
    def test_parse_equals_from_mapping_of_parse_markdown(self):
